 ...
 */
SDLTest_CommonState *SDLCALL SDLTest_CommonCreateState(char **argv, Uint32 flags); /* OXDK-patch: missing SDLCALL */
 ...
 */
int SDLCALL SDLTest_CommonArg(SDLTest_CommonState * state, int index); /* OXDK-patch: missing SDLCALL */
 ...
 */
void SDLCALL SDLTest_CommonLogUsage(SDLTest_CommonState * state, const char *argv0, const char **options); /* OXDK-patch: missing SDLCALL */
 ...
 */
const char *SDLCALL SDLTest_CommonUsage(SDLTest_CommonState * state); /* OXDK-patch: missing SDLCALL */
 ...
 */
SDL_bool SDLCALL SDLTest_CommonInit(SDLTest_CommonState * state); /* OXDK-patch: missing SDLCALL */
 ...
 */
SDL_bool SDLCALL SDLTest_CommonDefaultArgs(SDLTest_CommonState * state, const int argc, char **argv); /* OXDK-patch: missing SDLCALL */
 ...
 *
 */
void SDLCALL SDLTest_CommonEvent(SDLTest_CommonState * state, SDL_Event * event, int *done); /* OXDK-patch: missing SDLCALL */
 ...
 *
 */
void SDLCALL SDLTest_CommonQuit(SDLTest_CommonState * state); /* OXDK-patch: missing SDLCALL */
