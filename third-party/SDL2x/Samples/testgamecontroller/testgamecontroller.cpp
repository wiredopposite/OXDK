...
static SDL_GameControllerButton FindButtonAtPosition(int x, int y)
{
    ...
    for (i = 0; i < SDL_CONTROLLER_BUTTON_TOUCHPAD; ++i) {
        SDL_bool on_front = (SDL_bool) (i < SDL_CONTROLLER_BUTTON_PADDLE1 || i > SDL_CONTROLLER_BUTTON_PADDLE4);
...
#define VERBOSE_AXES
    ...
    if (gamecontroller) {
        ...
        /* Update LED based on left thumbstick position */
        {
            ...
            if (!set_LED) {
                set_LED = (SDL_bool) (x < -8000 || x > 8000 || y > 8000);
            }
            if (set_LED) {
                Uint8 r, g, b;
...
int main(int argc, char* argv[])
{
    ...
    SDL_Log("ptrs %d %d", window, screen);

    background_front = LoadTexture(screen, "D:\\controllermap.bmp", SDL_FALSE, NULL, NULL);
    background_back = LoadTexture(screen, "D:\\controllermap_back.bmp", SDL_FALSE, NULL, NULL);
    button_texture = LoadTexture(screen, "D:\\button.bmp", SDL_TRUE, NULL, NULL);
    axis_texture = LoadTexture(screen, "D:\\axis.bmp", SDL_TRUE, NULL, NULL);
